        ...
        <div className="footer-content">
          ...
          <div className="footer-col" data-aos="fade-up" data-aos-delay="300">
            ...
            <div className="contact-details">
              <p><i className="fas fa-phone"></i> <a href="tel:+18763141008">+1 (876) 314-1008</a></p>
              <p><i className="fas fa-envelope"></i> <a href="mailto:howardduffus@gmail.com">howardduffus@gmail.com</a></p>
              {/*
